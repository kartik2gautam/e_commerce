...
export const ActionCategory = () => {
  ...
  const applyFilters = () => {
    ...
    axios
      .get(
        `http://127.0.0.1:8000/api/product/action/filter-products/${filterform.min_price}/${filterform.max_price}/${filterform.publisher}/${filterform.sort_by}`
      )
      .then((response) => {
  ...
  const handleSearch = (inputstring) => {
    ...
    if (inputstring === "") {
      axios
        .get(`http://127.0.0.1:8000/api/product/search/action/`)
        .then((response) => {
          setstring("");
          setActionProducts(response.data["data"]);
          setFilteredProducts(response.data["data"]);
      ...
      axios
        .get(`http://127.0.0.1:8000/api/product/search/action/${string}`)
        .then((response) => {
