...
export const FightingCategory = () => {
  ...
  const applyFilters = () => {
    ...
    axios.get(`http://127.0.0.1:8000/api/product/fighting/filter-products/${filterform.min_price}/${filterform.max_price}/${filterform.publisher}/${filterform.sort_by}`)
    .then((response)=>{
  ...
  const handleSearch=(inputstring)=>{
    ...
    if(inputstring===''){
      axios.get(`http://127.0.0.1:8000/api/product/search/fighting/`)
      .then((response)=>{
        setstring('')
        setFilteredProducts(response.data['data'])
      })
    ...
    axios.get(`http://127.0.0.1:8000/api/product/search/fighting/${string}`)
          .then((response)=>{
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get(`http://127.0.0.1:8000/api/product/search/fighting/${string}`)
      .then((response) => {
              ...
              <div className=" text-white filter-div">
                <div className="form-group">
                  ...
                  >
                    ...
                    <option value="Warner Bros. Games" className="black-option-action">
                    Warner Bros. Games
                    </option>
                  </select>
                </div>
